...
const AddReview = () => {
    ...
    return (
        <Grid sx={{ width: '1150px', marginTop: '-24px', marginLeft: '-25px' }} container >
            <Grid item xs={12} md={12}>
                <Container sx={{ width: '50%', backgroundColor: '#ffffff52', textAlign: 'center', color: '#1565c0', py: 5, mt: 5 }}>
                    ...
                    {!isLoading && <form style={{ marginTop: '30px' }} onSubmit={handleReview}>
                        ...
                        <Button sx={{ width: '75%', m: 1, backgroundColor: '#1565c0' }} variant="contained" type="submit">Submit</Button>
                    </form>}
